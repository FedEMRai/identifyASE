...
add_aod_daily <- function(data,
  ...
  data <- data %>%
    ...
    mutate(
      ...
      aod_renal_daily = ifelse(creat_daily_hi >= creat_hi_lo_ratio * creat_baseline & (is.na(creat_hi_cutoff) | creat_daily_hi >= creat_hi_cutoff) & creat_baseline >= 0 & creat_daily_hi >= 0 & creat_daily_hi >= creat_baseline & esrd_icd != 1, 1, 0),
    ...
    mutate(
      ...
      aod_renal_daily_window = ifelse(creat_daily_hi >= creat_hi_lo_ratio * creat_baseline_window & creat_daily_hi >= 0 & creat_baseline_window >= 0 & (is.na(creat_hi_cutoff) | creat_daily_hi >= creat_hi_cutoff) & creat_daily_hi >= creat_baseline_window & esrd_icd != 1, 1, 0),
